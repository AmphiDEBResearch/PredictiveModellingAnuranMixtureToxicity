...
%
The model was implemented in the Julia programming language. All software code is available on github. 
\todo[inline]{Link to a public repo will be entered here; Repository will be supplied as zip archive for review}
%
...
\todo[inline]{alternatively refer to script file}
%
...
All supplemental data is available via \textbf{\color{red} INSERT LINK TO GITHUB REPO}.
